...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'main_node' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chris/RIN/catkinws_intern/install/${idir}'.  Ask the maintainer 'chris <chris@todo.todo>' to fix it.")
    endif()
